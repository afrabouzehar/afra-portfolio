...
function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center bg-gradient-to-br from-white to-blue-50 px-6 pt-20">
      
      {/* Greeting */}
      <p className="text-blue-500 font-semibold text-lg mb-2 tracking-widest uppercase">
        Hello, I'm
      </p>
